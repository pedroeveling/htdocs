...
<table id="tabela"> 	
	...
	<?php
            ...
            ?>
               ...
               <td> <input type="text" name="descricao" class="txt2" id="inputAddress" placeholder=" descricao do setor" value="<?php echo $nome;?>"></td>
              
			  </tr>
			  <tr><td>
       <label for="inputAddress">Gerente</label></td>
