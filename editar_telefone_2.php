...
<table id="tabela"> 	
    <tr>
            ...
            ?>
               ...
               <td> <input type="text" name="nome" class="txt2" id="inputAddress" placeholder="Fulado De Tals" value="<?php echo $ddd;?>"></td>
           </tr>
		   <tr>
                <td><label for="inputAddress">Numero</label>
              <td>  <input type="number" name="cpf" class="txt2" id="inputAddress" placeholder="1111111111" value="<?php echo $numero;?>"></td>
            </tr>
           <tr>    
